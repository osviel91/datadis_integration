...
SENSORS: tuple[DatadisSensorEntityDescription, ...] = (
    ...
    DatadisSensorEntityDescription(
        key="days_with_data_this_month",
        name="Days with Data This Month",
        icon="mdi:calendar-check",
        value_fn=lambda data: data.days_with_data_this_month,
    ),
    DatadisSensorEntityDescription(
        key="current_month_daily_average",
        name="Current Month Daily Average",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:chart-bar",
    ...
    DatadisSensorEntityDescription(
        key="highest_daily_consumption_this_month",
        name="Highest Daily Consumption This Month",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        device_class=SensorDeviceClass.ENERGY,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:arrow-up-bold",
        value_fn=lambda data: data.highest_daily_consumption_this_month_kwh,
    ),
    DatadisSensorEntityDescription(
